function rel_pattern(strFilenamConfig, astSampleCase, num_total_cases)
...
if ptn_info.model_option ~= 22 & ptn_info.model_option ~= 6 %% no likelihood for K-NN
    iFigId = 30;
